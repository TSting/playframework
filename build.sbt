...
lazy val BuildLinkProject = PlayNonCrossBuiltProject("Build-Link", "dev-mode/build-link")
  .settings(publishTo := Some(Resolver.file("file", new File(System.getProperty("user.home") + "/Development/sting-mvn-repo"))))
...
lazy val PlayExceptionsProject = PlayNonCrossBuiltProject("Play-Exceptions", "core/play-exceptions").settings(publishTo := Some(Resolver.file("file", new File(System.getProperty("user.home") + "/Development/sting-mvn-repo"))))
